...
BOOL CNANDDlg::OnInitDialog()
{
    ...
    m_imagelist.SetHeadings(_T("Name, 80; Type, 60;Start, 60;End, 60;Block, 60"));
...
void CNANDDlg::Download()
{
    ...
    if(!m_filename.IsEmpty()) {
        ...
        GetDlgItem(IDC_NAND_DOWNLOAD)->SetWindowText(_T("Program"));
        //UpdateData(FALSE);
...
void CNANDDlg::OnBnClickedNandDownload()
{
    ...
    if(dlgText.CompareNoCase(_T("Program"))==0) {
        ...
        GetDlgItem(IDC_NAND_DOWNLOAD)->EnableWindow(FALSE);
        m_progress.SetPos(0);
    }
}
...
void CNANDDlg::OnBnClickedNandRead()
{
    ...
    read_dlg.type=1;  /* 0 => SPI, 1 =>NAND, 2=>MMC, 3 =>SPI NAND, */
...
void CNANDDlg::OnBnClickedNandBrowse()
{
    ...
    //    m_imagename = m_imagename.Mid(0,32);
