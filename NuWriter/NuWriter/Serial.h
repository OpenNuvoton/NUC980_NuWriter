...
typedef struct _INFO_T
{
	...
	DWORD   SPI_ID;
	DWORD   SPI_uIsUserConfig;
    BYTE    SPI_QuadReadCmd;
    BYTE    SPI_ReadStatusCmd;
    BYTE    SPI_WriteStatusCmd;
    BYTE    SPI_StatusValue;
    BYTE    SPI_dummybyte;
	DWORD   EMMC_uBlock;
	DWORD   EMMC_uReserved;
	DWORD   SPINand_uIsUserConfig;
    DWORD   SPINand_ID;
    WORD	SPINand_PageSize;
    WORD	SPINand_SpareArea;
    BYTE	SPINand_QuadReadCmd;
    BYTE	SPINand_ReadStatusCmd;
    BYTE	SPINand_WriteStatusCmd;
    BYTE	SPINand_StatusValue;
