...
public:
    ...
    BOOL XUSB_FastSPINANDErase(int id, CString& portName);
    BOOL XUSB_FastSPINANDBurn(int id, CString& portName,CString& m_pathName,int *len);
    BOOL XUSB_FastSPINANDVerify(int id, CString& portName, CString& m_pathName);
	...
	afx_msg void OnBnClickedRadioFastSpinand();
	afx_msg void OnBnClickedFastNandUsrconfig();
	CButton m_nandflashInfo_check;
	CButton m_spinandflashInfo_check;
	afx_msg void OnBnClickedFastSpinandUsrconfig();
	afx_msg void OnBnClickedFastSpinorUsrconfig();
	CButton m_spinor_check;
};
