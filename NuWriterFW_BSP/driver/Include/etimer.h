 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 18/11/01 10:16a $
 * @brief    NUC980 series ETIMER driver header file
 *
 * @note
...
/** @addtogroup NUC980_ETIMER_Driver ETIMER Driver
  @{
*/

/** @addtogroup NUC980_ETIMER_EXPORTED_CONSTANTS ETIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC980_ETIMER_EXPORTED_CONSTANTS */

/** @addtogroup NUC980_ETIMER_EXPORTED_FUNCTIONS ETIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC980_ETIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC980_ETIMER_Driver */
